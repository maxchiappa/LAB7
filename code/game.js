...
var newVector = new Vector(10,10);
...
Coin.prototype.act = function(step) {
    ...
    var wobblePos = Math.sin (this.wobble) * wobbleDistance;
...
Level.prototype.obstacleAt = function (pos, size) {
  ...
  // Makes top,bottom and side of level as walls
...
var newPos = this.pos.plus(motion);
  ...
  // if the yare touching same obstacle
  if (obstacle) {
